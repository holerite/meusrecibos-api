/*
  ...
  - You are about to drop the column `employeeId` on the `Receipts` table. All the data in the column will be lost.
...
INSERT INTO "new_Receipts" ("companyId", "enrolmentId", "file", "id", "opened", "payday", "receiptsTypesId", "validity") SELECT "companyId", "enrolmentId", "file", "id", "opened", "payday", "receiptsTypesId", "validity" FROM "Receipts";
DROP TABLE "Receipts";
